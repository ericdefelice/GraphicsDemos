...
{
    Float2 retVal;
    retVal.x = GumshoeFramework10::Clamp(val.x, min.x, max.x);
    retVal.y = GumshoeFramework10::Clamp(val.y, min.y, max.y);
    return retVal;
}
...
Float3 Float3::Clamp(const Float3& val, const Float3& min, const Float3& max)
{
    ...
    retVal.x = GumshoeFramework10::Clamp(val.x, min.x, max.x);
    retVal.y = GumshoeFramework10::Clamp(val.y, min.y, max.y);
    retVal.z = GumshoeFramework10::Clamp(val.z, min.z, max.z);
    return retVal;
}
...
Float4 Float4::Clamp(const Float4& val, const Float4& min, const Float4& max)
{
    ...
    retVal.y = GumshoeFramework10::Clamp(val.y, min.y, max.y);
    retVal.z = GumshoeFramework10::Clamp(val.z, min.z, max.z);
    retVal.w = GumshoeFramework10::Clamp(val.w, min.w, max.w);
    return retVal;
}
